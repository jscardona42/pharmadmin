...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-06-2020 a las 18:07:42
...
(2, 'Roles', 'crol', '<i class=\"nav-icon fas fa-users\"></i>', 5, '2020-05-19 17:41:32', '2020-05-19 17:41:32', 1),
...
(5, 'Reportes', 'creporte', '<i class=\"nav-icon fas fa-users\"></i>', 4, '2020-05-19 21:32:55', '2020-05-19 21:32:55', 1),
(6, 'Administración', 'cpermiso', '<i class=\"nav-icon fas fa-users\"></i>', 6, '2020-05-24 18:12:23', '2020-05-24 18:12:23', 1),
(7, 'Prueba', 'cprueba', '<i class=\"nav-icon fas fa-users\"></i>', 7, '2020-05-25 21:13:54', '2020-05-25 21:13:54', 0),
(8, 'Prueba2', 'dsds', '<i class=\"nav-icon fas fa-users\"></i>', 8, '2020-05-25 21:15:40', '2020-05-25 21:15:40', 0),
(9, 'Prueba3', 'cprueba', '8', NULL, '2020-05-27 16:52:56', '2020-05-27 16:52:56', 1),
(10, 'Prueba3', 'y', 'y', NULL, '2020-05-27 16:53:50', '2020-05-27 16:53:50', 1);
...
INSERT INTO `permisos` (`id`, `permiso`, `modulos_id`, `fechacreacion`, `fechaactualizacion`, `estado`) VALUES
(1, 'Productos', 1, '2020-05-20 16:18:19', '2020-05-20 16:18:19', 1),
(2, 'Roles', 2, '2020-05-20 16:18:19', '2020-05-20 16:18:19', 1),
(3, 'Categorias', 3, '2020-05-20 16:18:34', '2020-05-20 16:18:34', 1),
(4, 'Movimientos', 4, '2020-05-20 16:18:34', '2020-05-20 16:18:34', 1),
(5, 'Reportes', 5, '2020-05-20 16:18:47', '2020-05-20 16:18:47', 1),
(6, 'Permisos', 6, '2020-05-24 18:13:37', '2020-05-24 18:13:37', 1);
...
(2, 'Yaky', 'Sanchez Cardozo', 1, '1110263261', '1998-01-23', 'yaky0723', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 1, NULL, NULL, 3),
...
(4, 'Betametasona', 1, 2, '2020-05-24 18:10:12', '2020-05-24 18:10:12');
...
(3, 'Supervisor', 1, '2020-04-30 22:04:19', '2020-04-30 22:04:19'),
(4, 'Supervisor5', 1, '2020-05-01 01:25:36', '2020-05-01 01:25:36'),
(34, 'Gerente', 1, '2020-05-02 20:52:41', '2020-05-02 20:52:41'),
(35, 'Director', 0, '2020-05-02 20:53:48', '2020-05-02 20:53:48'),
...
INSERT INTO `rolespermisos` (`id`, `roles_id`, `permisos_id`, `fechacreacion`, `fechaactualizacion`, `estado`) VALUES
(1, 1, 1, '2020-05-20 16:24:40', '2020-05-20 16:24:40', 1),
(2, 1, 2, '2020-05-20 16:24:40', '2020-05-20 16:24:40', 1),
(3, 1, 3, '2020-05-20 16:24:57', '2020-05-20 16:24:57', 1),
(4, 1, 4, '2020-05-20 16:24:57', '2020-05-20 16:24:57', 1),
(5, 1, 5, '2020-05-20 16:29:05', '2020-05-20 16:29:05', 1),
(6, 3, 2, '2020-05-20 16:31:13', '2020-05-20 16:31:13', 1),
(7, 3, 4, '2020-05-20 16:31:13', '2020-05-20 16:31:13', 1),
(8, 1, 6, '2020-05-24 18:14:03', '2020-05-24 18:14:03', 1);
...
(3, 'Modulos', 6, 'cmodulo', '<i class=\"far fa-circle nav-icon\"></i>', 2, '2020-05-24 18:21:21', '2020-05-24 18:21:21', 1),
(4, 'Permisos', 6, 'cpermiso', '<i class=\"far fa-circle nav-icon\"></i>', 1, '2020-05-24 18:21:21', '2020-05-24 18:21:21', 1);
...
--
ALTER TABLE `permisos`
  ADD CONSTRAINT `permisos_ibfk_1` FOREIGN KEY (`modulos_id`) REFERENCES `modulos` (`id`);
...
--
ALTER TABLE `rolespermisos`
  ADD CONSTRAINT `rolespermisos_ibfk_1` FOREIGN KEY (`roles_id`) REFERENCES `roles` (`id`),
  ADD CONSTRAINT `rolespermisos_ibfk_2` FOREIGN KEY (`permisos_id`) REFERENCES `permisos` (`id`);
COMMIT;
